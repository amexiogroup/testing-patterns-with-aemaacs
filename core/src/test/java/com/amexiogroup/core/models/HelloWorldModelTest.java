 ...
 */
package com.amexiogroup.core.models;
...
import com.amexiogroup.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
                "sling:resourceType", "testing-patterns-with-aemaacs/components/helloworld");
